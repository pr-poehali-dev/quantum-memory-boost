        ...
        <div className="relative z-20 mx-auto max-w-5xl rounded-[40px] py-6 md:p-10 xl:py-20">
          ...
          <div className="space-y-4 md:space-y-6">
            <p className="text-base md:text-xl lg:text-2xl xl:text-3xl text-white/90 [text-shadow:_0_2px_10px_rgb(0_0_0_/_50%)] font-open-sans-custom leading-relaxed">
              Мы работаем на рынке Steam-аккаунтов уже несколько лет и за это время помогли тысячам игроков найти идеальный аккаунт. Каждая сделка — это доверие, и мы его ценим.
            </p>
            <p className="text-base md:text-xl lg:text-2xl xl:text-3xl text-white/90 [text-shadow:_0_2px_10px_rgb(0_0_0_/_50%)] font-open-sans-custom leading-relaxed">
              Неважно, нужен ли вам стартовый аккаунт для тренировок или легендарный с редкими скинами — мы подберём лучший вариант под ваш запрос и гарантируем безопасную передачу.
            </p>
          </div>
        </div>
      </div>
